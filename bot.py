    ...
    def _generate_final_prediction(self, models_results, home_stats, away_stats, poisson_result):
        ...
        try:
            ...
            if count > 0:
                ...
                home_strength = away_strength = 0.5 # Valeur par défaut si aucun modèle n'a de résultat
...
"""
        ...
        for i, pred in enumerate(predictions, 1):
            rank_emoji = ['🥇', '🥈', '🥉', '🎯', '🎯'][i-1] # Gère jusqu'à 5 éléments
...
"""
        ...
        full_message = f"{header}{predictions_text}{footer}"
        ...
        try:
            ...
            for match in all_matches:
                ...
                try:
                    ...
                    # Choix du collecteur pour récupérer l'historique
